--
-- XXDO_PO_ASN_RECEIPT_SER_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_PO_ASN_RECEIPT_SER_LOG
(
...
--
-- XXDO_PO_ASN_RECEIPT_SER_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_PO_ASN_RECEIPT_SER_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_PO_ASN_RECEIPT_SER_LOG FOR XXDO.XXDO_PO_ASN_RECEIPT_SER_LOG
/
