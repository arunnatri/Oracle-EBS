--
-- XXD_ONT_SHIPMENT_DETAILS_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_SHIPMENT_DETAILS_T
(
  RECORD_ID                  NUMBER,
  ...
  SO_CUSTOMER                VARCHAR2(240 BYTE),
  SO_CUST_PO_NUMBER          VARCHAR2(50 BYTE),
  SO_ORDER_NUMBER            NUMBER,
  SO_HEADER_ID               NUMBER,
  SO_ORDER_TYPE_ID           NUMBER,
  SO_LINE_ID                 NUMBER,
  SO_ORDER_LINE_NUM          VARCHAR2(50 BYTE),
  SO_LINE_FLOW_STATUS_CODE   VARCHAR2(30 BYTE),
...
--
-- XXD_ONT_SHIPMENT_DETAILS_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_SHIPMENT_DETAILS_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_SHIPMENT_DETAILS_T FOR XXDO.XXD_ONT_SHIPMENT_DETAILS_T
/
