--
-- XXDO_INV_SYNC_SERIAL_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_INV_SYNC_SERIAL_STG
(
...
--   XXDO_INV_SYNC_SERIAL_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_INV_SYNC_SERIAL_STG FOR XXDO.XXDO_INV_SYNC_SERIAL_STG
/
