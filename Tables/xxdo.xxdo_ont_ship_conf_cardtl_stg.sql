--
-- XXDO_ONT_SHIP_CONF_CARDTL_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
(
...
--
-- XXDO_ONT_SHIP_CONF_CARDTL_N1  (Index) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARDTL_STG (Table)
--
CREATE INDEX XXDO.XXDO_ONT_SHIP_CONF_CARDTL_N1 ON XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
(PROCESS_STATUS, SHIPMENT_NUMBER, ORDER_NUMBER, CARTON_NUMBER, LINE_NUMBER, 
ITEM_NUMBER)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXDO_ONT_SHIP_CONF_CARDTL_N2  (Index) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARDTL_STG (Table)
--
CREATE INDEX XXDO.XXDO_ONT_SHIP_CONF_CARDTL_N2 ON XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
...
--
-- XXDO_ONT_SHIP_CONF_CARDTL_N3  (Index) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARDTL_STG (Table)
--
CREATE INDEX XXDO.XXDO_ONT_SHIP_CONF_CARDTL_N3 ON XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
(PROCESS_STATUS, SHIPMENT_NUMBER, ORDER_NUMBER, LINE_NUMBER)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
INITRANS   2
...
--
-- XXDO_ONT_SHIP_CONF_CARDTL_STG  (Synonym) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARDTL_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_SHIP_CONF_CARDTL_STG FOR XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
/
...
--   XXDO_ONT_SHIP_CONF_CARDTL_STG (Table)
--
CREATE OR REPLACE SYNONYM SOA_INT.XXDO_ONT_SHIP_CONF_CARDTL_STG FOR XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG
/


GRANT DELETE, INSERT, SELECT, UPDATE ON XXDO.XXDO_ONT_SHIP_CONF_CARDTL_STG TO SOA_INT
/
