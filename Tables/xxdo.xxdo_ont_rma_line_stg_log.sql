--
-- XXDO_ONT_RMA_LINE_STG_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_ONT_RMA_LINE_STG_LOG
(
...
--
-- XXDO_ONT_RMA_LINE_STG_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_ONT_RMA_LINE_STG_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_RMA_LINE_STG_LOG FOR XXDO.XXDO_ONT_RMA_LINE_STG_LOG
/
