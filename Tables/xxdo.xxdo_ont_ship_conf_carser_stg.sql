--
-- XXDO_ONT_SHIP_CONF_CARSER_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_ONT_SHIP_CONF_CARSER_STG
(
  WH_ID             VARCHAR2(10 BYTE),
  SHIPMENT_NUMBER   VARCHAR2(30 BYTE),
  ORDER_NUMBER      VARCHAR2(30 BYTE),
  CARTON_NUMBER     VARCHAR2(22 BYTE),
...
--
-- XXDO_ONT_SHIP_CONF_CARSER_STG  (Synonym) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARSER_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_SHIP_CONF_CARSER_STG FOR XXDO.XXDO_ONT_SHIP_CONF_CARSER_STG
/
