--
-- XXD_OE_CAN_LOYALTY_POINTS_T  (Table) 
--
CREATE TABLE XXDO.XXD_OE_CAN_LOYALTY_POINTS_T
(
...
--
-- XXD_OE_CAN_LOYALTY_POINTS_T  (Synonym) 
--
--  Dependencies: 
--   XXD_OE_CAN_LOYALTY_POINTS_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_OE_CAN_LOYALTY_POINTS_T FOR XXDO.XXD_OE_CAN_LOYALTY_POINTS_T
/


GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, READ, DEBUG, FLASHBACK ON XXDO.XXD_OE_CAN_LOYALTY_POINTS_T TO APPS
/
