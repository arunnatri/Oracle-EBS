--
-- XXDO_PO_ASN_RECEIPT_SER_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_PO_ASN_RECEIPT_SER_STG
(
...
--   XXDO_PO_ASN_RECEIPT_SER_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_PO_ASN_RECEIPT_SER_STG FOR XXDO.XXDO_PO_ASN_RECEIPT_SER_STG
/
