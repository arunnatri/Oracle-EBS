--
-- XXD_INV_MTL_SYSTEM_ITEMS_T  (Table) 
--
CREATE TABLE XXDO.XXD_INV_MTL_SYSTEM_ITEMS_T
(
...
--
-- XXD_INV_MTL_SYSTEM_ITEMS_N1  (Index) 
--
--  Dependencies: 
--   XXD_INV_MTL_SYSTEM_ITEMS_T (Table)
--
CREATE INDEX XXDO.XXD_INV_MTL_SYSTEM_ITEMS_N1 ON XXDO.XXD_INV_MTL_SYSTEM_ITEMS_T
...
--
-- XXD_INV_MTL_SYSTEM_ITEMS_T  (Synonym) 
--
--  Dependencies: 
--   XXD_INV_MTL_SYSTEM_ITEMS_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_INV_MTL_SYSTEM_ITEMS_T FOR XXDO.XXD_INV_MTL_SYSTEM_ITEMS_T
/
