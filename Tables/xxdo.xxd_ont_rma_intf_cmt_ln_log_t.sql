--
-- XXD_ONT_RMA_INTF_CMT_LN_LOG_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_RMA_INTF_CMT_LN_LOG_T
(
...
--
-- XXD_ONT_RMA_INTF_CMT_LN_LOG_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_RMA_INTF_CMT_LN_LOG_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_RMA_INTF_CMT_LN_LOG_T FOR XXDO.XXD_ONT_RMA_INTF_CMT_LN_LOG_T
/
