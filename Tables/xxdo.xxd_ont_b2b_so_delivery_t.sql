--
-- XXD_ONT_B2B_SO_DELIVERY_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_B2B_SO_DELIVERY_T
(
...
--
-- XXD_ONT_B2B_SO_DELIVERY_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_DELIVERY_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_B2B_SO_DELIVERY_N1 ON XXDO.XXD_ONT_B2B_SO_DELIVERY_T
(BATCH_ID, SOURCE_HEADER_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
INITRANS   2
...
--
-- XXD_ONT_B2B_SO_DELIVERY_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_DELIVERY_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_B2B_SO_DELIVERY_T FOR XXDO.XXD_ONT_B2B_SO_DELIVERY_T
/
