--
-- XXDO_ONT_RMA_HDR_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_ONT_RMA_HDR_STG
(
...
--
-- XXDO_ONT_RMA_HDR_STG_IDX1  (Index) 
--
--  Dependencies: 
--   XXDO_ONT_RMA_HDR_STG (Table)
--
CREATE INDEX XXDO.XXDO_ONT_RMA_HDR_STG_IDX1 ON XXDO.XXDO_ONT_RMA_HDR_STG
...
--   XXDO_ONT_RMA_HDR_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_RMA_HDR_STG FOR XXDO.XXDO_ONT_RMA_HDR_STG
/
...
--   XXDO_ONT_RMA_HDR_STG (Table)
--
CREATE OR REPLACE SYNONYM SOA_INT.XXDO_ONT_RMA_HDR_STG FOR XXDO.XXDO_ONT_RMA_HDR_STG
/


GRANT DELETE, INSERT, SELECT, UPDATE ON XXDO.XXDO_ONT_RMA_HDR_STG TO SOA_INT
/
