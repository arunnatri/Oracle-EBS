--
-- XXD_ONT_B2B_SO_HEADERS_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_B2B_SO_HEADERS_T
(
  HEADER_ID        NUMBER,
  ORG_ID           NUMBER,
...
--
-- XXD_ONT_B2B_SO_HEADERS_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_HEADERS_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_B2B_SO_HEADERS_N1 ON XXDO.XXD_ONT_B2B_SO_HEADERS_T
(BATCH_ID, HEADER_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_ONT_B2B_SO_HEADERS_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_HEADERS_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_B2B_SO_HEADERS_T FOR XXDO.XXD_ONT_B2B_SO_HEADERS_T
/
