--
-- XXDO_ONT_SHIP_CONF_XML_LOG  (Table) 
--
--  Dependencies: 
--   STANDARD (Package)
--   XMLTYPE (Type)
--
CREATE TABLE XXDO.XXDO_ONT_SHIP_CONF_XML_LOG
(
...
--
-- XXDO_ONT_SHIP_CONF_XML_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_XML_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_SHIP_CONF_XML_LOG FOR XXDO.XXDO_ONT_SHIP_CONF_XML_LOG
/
