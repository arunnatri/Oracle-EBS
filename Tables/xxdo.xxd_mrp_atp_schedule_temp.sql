--
-- XXD_MRP_ATP_SCHEDULE_TEMP  (Table) 
--
CREATE TABLE XXDO.XXD_MRP_ATP_SCHEDULE_TEMP
(
  ACTION                         NUMBER,
  ...
  HDR_TBL_FK_SEQ_ID              NUMBER,
  NEW_QUANTITY                   NUMBER,
  NEGATIVE_ATP_QTY               NUMBER,
...
--
-- XXD_MRP_ATP_SCHEDULE_TEMP  (Synonym) 
--
--  Dependencies: 
--   XXD_MRP_ATP_SCHEDULE_TEMP (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_MRP_ATP_SCHEDULE_TEMP FOR XXDO.XXD_MRP_ATP_SCHEDULE_TEMP
/
