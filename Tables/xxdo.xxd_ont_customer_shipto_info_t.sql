--
-- XXD_ONT_CUSTOMER_SHIPTO_INFO_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_CUSTOMER_SHIPTO_INFO_T
(
  ...
  SHIP_TO_LOCATION_NAME   VARCHAR2(40 BYTE),
...
--
-- XXD_ONT_CUST_SHIPTO_INFO_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_CUSTOMER_SHIPTO_INFO_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_CUST_SHIPTO_INFO_N1 ON XXDO.XXD_ONT_CUSTOMER_SHIPTO_INFO_T
(CUST_ACCOUNT_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_ONT_CUSTOMER_SHIPTO_INFO_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_CUSTOMER_SHIPTO_INFO_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_CUSTOMER_SHIPTO_INFO_T FOR XXDO.XXD_ONT_CUSTOMER_SHIPTO_INFO_T
/
