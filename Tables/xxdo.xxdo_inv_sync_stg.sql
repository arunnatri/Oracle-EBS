--
-- XXDO_INV_SYNC_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_INV_SYNC_STG
(
  ...
  INT_STATUS         VARCHAR2(50 BYTE),
  EBS_UOM            VARCHAR2(10 BYTE),
...
--
-- XXDO_INV_INV_STG_IDX  (Index) 
--
--  Dependencies: 
--   XXDO_INV_SYNC_STG (Table)
--
CREATE INDEX XXDO.XXDO_INV_INV_STG_IDX ON XXDO.XXDO_INV_SYNC_STG
...
--   XXDO_INV_SYNC_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_INV_SYNC_STG FOR XXDO.XXDO_INV_SYNC_STG
/
