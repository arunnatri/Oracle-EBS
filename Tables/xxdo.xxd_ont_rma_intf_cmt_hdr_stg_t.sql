--
-- XXD_ONT_RMA_INTF_CMT_HDR_STG_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_RMA_INTF_CMT_HDR_STG_T
(
...
--
-- XXD_ONT_RMA_INTF_CMT_HDR_ST_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_RMA_INTF_CMT_HDR_STG_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_RMA_INTF_CMT_HDR_ST_N1 ON XXDO.XXD_ONT_RMA_INTF_CMT_HDR_STG_T
(HEADER_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_ONT_RMA_INTF_CMT_HDR_STG_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_RMA_INTF_CMT_HDR_STG_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_RMA_INTF_CMT_HDR_STG_T FOR XXDO.XXD_ONT_RMA_INTF_CMT_HDR_STG_T
/


GRANT SELECT, UPDATE ON XXDO.XXD_ONT_RMA_INTF_CMT_HDR_STG_T TO SOA_INT
/
