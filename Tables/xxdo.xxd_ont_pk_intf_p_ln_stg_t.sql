--
-- XXD_ONT_PK_INTF_P_LN_STG_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_PK_INTF_P_LN_STG_T
(
...
--
-- XXD_ONT_PK_INTF_P_LN_STG_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_PK_INTF_P_LN_STG_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_PK_INTF_P_LN_STG_T FOR XXDO.XXD_ONT_PK_INTF_P_LN_STG_T
/


GRANT DELETE, INSERT, SELECT, UPDATE ON XXDO.XXD_ONT_PK_INTF_P_LN_STG_T TO SOA_INT
/
