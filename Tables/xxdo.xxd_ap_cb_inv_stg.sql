--
-- XXD_AP_CB_INV_STG  (Table) 
--
CREATE TABLE XXDO.XXD_AP_CB_INV_STG
(
  INVOICE_ID                                     NUMBER,
  ...
  EXCHANGE_DATE                                  DATE,
  ORIGINAL_CURRENCY_CODE                         VARCHAR2(20 BYTE)
)
...
--
-- XXD_AP_CB_INV_STG  (Synonym) 
--
--  Dependencies: 
--   XXD_AP_CB_INV_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_AP_CB_INV_STG FOR XXDO.XXD_AP_CB_INV_STG
/
