--
-- XXDO_PO_FACTORY_STG  (Table) 
--
CREATE TABLE XXDO.XXDO_PO_FACTORY_STG
(
  WAREHOUSE_CODE     VARCHAR2(10 BYTE)          NOT NULL,
  PO_NUMBER          VARCHAR2(30 BYTE)          NOT NULL,
  VENDOR_CODE        VARCHAR2(10 BYTE)          NOT NULL,
...
--
-- XXDO_PO_FACTORY_STG  (Synonym) 
--
--  Dependencies: 
--   XXDO_PO_FACTORY_STG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_PO_FACTORY_STG FOR XXDO.XXDO_PO_FACTORY_STG
/
