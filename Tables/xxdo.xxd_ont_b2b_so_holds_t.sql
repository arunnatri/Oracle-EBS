--
-- XXD_ONT_B2B_SO_HOLDS_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_B2B_SO_HOLDS_T
(
  HEADER_ID       NUMBER,
  ORG_ID          NUMBER,
  BATCH_DATE      DATE,
...
--
-- XXD_ONT_B2B_SO_HOLDS_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_HOLDS_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_B2B_SO_HOLDS_N1 ON XXDO.XXD_ONT_B2B_SO_HOLDS_T
(BATCH_ID, HEADER_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_ONT_B2B_SO_HOLDS_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_B2B_SO_HOLDS_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_B2B_SO_HOLDS_T FOR XXDO.XXD_ONT_B2B_SO_HOLDS_T
/
