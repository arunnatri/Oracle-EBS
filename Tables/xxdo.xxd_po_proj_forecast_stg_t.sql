--
-- XXD_PO_PROJ_FORECAST_STG_T  (Table) 
--
CREATE TABLE XXDO.XXD_PO_PROJ_FORECAST_STG_T
(
...
--
-- XXD_PO_PROJ_FORECAST_STG_N1  (Index) 
--
--  Dependencies: 
--   XXD_PO_PROJ_FORECAST_STG_T (Table)
--
CREATE INDEX XXDO.XXD_PO_PROJ_FORECAST_STG_N1 ON XXDO.XXD_PO_PROJ_FORECAST_STG_T
(PO_LINE_ID, PO_LINE_LOCATION_ID, REQUISITION_LINE_ID, SHIPMENT_LINE_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
INITRANS   2
...
--
-- XXD_PO_PROJ_FORECAST_STG_T  (Synonym) 
--
--  Dependencies: 
--   XXD_PO_PROJ_FORECAST_STG_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_PO_PROJ_FORECAST_STG_T FOR XXDO.XXD_PO_PROJ_FORECAST_STG_T
/


GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, READ, DEBUG, FLASHBACK ON XXDO.XXD_PO_PROJ_FORECAST_STG_T TO APPS
/
