--
-- XXD_INV_MTL_CATEGORIES_T  (Table) 
--
CREATE TABLE XXDO.XXD_INV_MTL_CATEGORIES_T
(
  CATEGORY_ID     NUMBER,
  BATCH_DATE      DATE,
  BATCH_ID        NUMBER,
...
--
-- XXD_INV_CAT_DATE_N1  (Index) 
--
--  Dependencies: 
--   XXD_INV_MTL_CATEGORIES_T (Table)
--
CREATE INDEX XXDO.XXD_INV_CAT_DATE_N1 ON XXDO.XXD_INV_MTL_CATEGORIES_T
(BATCH_DATE)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_INV_MTL_CATEGORIES_N1  (Index) 
--
--  Dependencies: 
--   XXD_INV_MTL_CATEGORIES_T (Table)
--
CREATE INDEX XXDO.XXD_INV_MTL_CATEGORIES_N1 ON XXDO.XXD_INV_MTL_CATEGORIES_T
(CATEGORY_ID)
LOGGING
TABLESPACE CUSTOM_TX_TS
PCTFREE    10
...
--
-- XXD_INV_MTL_CATEGORIES_T  (Synonym) 
--
--  Dependencies: 
--   XXD_INV_MTL_CATEGORIES_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_INV_MTL_CATEGORIES_T FOR XXDO.XXD_INV_MTL_CATEGORIES_T
/
