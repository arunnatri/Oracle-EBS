--
-- XXDO_PO_ASN_SERIALS_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_PO_ASN_SERIALS_LOG
(
...
--
-- XXDO_PO_ASN_SERIALS_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_PO_ASN_SERIALS_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_PO_ASN_SERIALS_LOG FOR XXDO.XXDO_PO_ASN_SERIALS_LOG
/
