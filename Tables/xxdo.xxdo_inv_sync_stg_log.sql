--
-- XXDO_INV_SYNC_STG_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_INV_SYNC_STG_LOG
(
...
--
-- XXDO_INV_SYNC_STG_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_INV_SYNC_STG_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_INV_SYNC_STG_LOG FOR XXDO.XXDO_INV_SYNC_STG_LOG
/
