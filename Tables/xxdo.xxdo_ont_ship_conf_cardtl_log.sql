--
-- XXDO_ONT_SHIP_CONF_CARDTL_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_ONT_SHIP_CONF_CARDTL_LOG
(
...
--
-- XXDO_ONT_SHIP_CONF_CARDTL_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_ONT_SHIP_CONF_CARDTL_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_ONT_SHIP_CONF_CARDTL_LOG FOR XXDO.XXDO_ONT_SHIP_CONF_CARDTL_LOG
/
