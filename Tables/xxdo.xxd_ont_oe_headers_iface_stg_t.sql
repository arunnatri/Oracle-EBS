--
-- XXD_ONT_OE_HEADERS_IFACE_STG_T  (Table) 
--
CREATE TABLE XXDO.XXD_ONT_OE_HEADERS_IFACE_STG_T
(
...
--
-- XXD_ONT_HEADERS_IFACE_STG_N1  (Index) 
--
--  Dependencies: 
--   XXD_ONT_OE_HEADERS_IFACE_STG_T (Table)
--
CREATE INDEX XXDO.XXD_ONT_HEADERS_IFACE_STG_N1 ON XXDO.XXD_ONT_OE_HEADERS_IFACE_STG_T
...
--
-- XXD_ONT_OE_HEADERS_IFACE_STG_T  (Synonym) 
--
--  Dependencies: 
--   XXD_ONT_OE_HEADERS_IFACE_STG_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_ONT_OE_HEADERS_IFACE_STG_T FOR XXDO.XXD_ONT_OE_HEADERS_IFACE_STG_T
/
...
--   XXD_ONT_OE_HEADERS_IFACE_STG_T (Table)
--
CREATE OR REPLACE SYNONYM SOA_INT.XXD_ONT_OE_HEADERS_IFACE_STG_T FOR XXDO.XXD_ONT_OE_HEADERS_IFACE_STG_T
/


GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON XXDO.XXD_ONT_OE_HEADERS_IFACE_STG_T TO SOA_INT
/
