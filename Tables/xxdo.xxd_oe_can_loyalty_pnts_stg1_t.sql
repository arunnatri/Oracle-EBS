--
-- XXD_OE_CAN_LOYALTY_PNTS_STG1_T  (Table) 
--
CREATE TABLE XXDO.XXD_OE_CAN_LOYALTY_PNTS_STG1_T
(
  ...
  ACQ_CLOSED_MEMBER              VARCHAR2(100 BYTE),
  ACQ_CLOSED_MEMBER_LOCAL_VAL    VARCHAR2(100 BYTE),
...
--
-- XXD_OE_CAN_LOYALTY_PNTS_STG1_T  (Synonym) 
--
--  Dependencies: 
--   XXD_OE_CAN_LOYALTY_PNTS_STG1_T (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXD_OE_CAN_LOYALTY_PNTS_STG1_T FOR XXDO.XXD_OE_CAN_LOYALTY_PNTS_STG1_T
/


GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, READ, DEBUG, FLASHBACK ON XXDO.XXD_OE_CAN_LOYALTY_PNTS_STG1_T TO APPS
/
