--
-- XXDO_PO_ASN_PO_LINES_LOG  (Table) 
--
CREATE TABLE XXDO.XXDO_PO_ASN_PO_LINES_LOG
(
...
--
-- XXDO_PO_ASN_PO_LINES_LOG  (Synonym) 
--
--  Dependencies: 
--   XXDO_PO_ASN_PO_LINES_LOG (Table)
--
CREATE OR REPLACE SYNONYM APPS.XXDO_PO_ASN_PO_LINES_LOG FOR XXDO.XXDO_PO_ASN_PO_LINES_LOG
/
