--
-- XXDOINV_CONSOL_INV_EXTRACT_PKG  (Package Body) 
--
/* Formatted on 4/26/2023 4:40:35 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE BODY APPS."XXDOINV_CONSOL_INV_EXTRACT_PKG"
/********************************************************************************************
  *                                                                                         *
  * History                                                                                 *
  ...
  * 3.2     31-MAR-2021     Showkath Ali            AAR Project - CCR0009287                *
  * 3.3     28-Jun-2021     Showkath Ali            CCR0009425                              *
  * 3.4     29-Jul-2021     Showkath Ali            CCR0009491
  * 3.5     02-APR-2022     Showkath Ali            CCR0009608
  * 3.6     12-Aug-2022     Showkath Ali            CCR0010109
  *******************************************************************************************/
IS
    ...
    */
    -- procedure to load the data in temp tables for intransit quantity  -- 3.6
    ...
    IS
        ...
        l_total_cost                     NUMBER;
        -- End changes by BT Technology Team on  23/01/2014
        l_total_value                    NUMBER; -- Added by BT Technology Team on 12-Jun-2015 for defect#2322
        --Start changes by BT Technology Team 22-JUN-2015 for defect#2322
        l_intrans_val                    NUMBER;
        l_intrans_rec_val                NUMBER;        --Added for change 3.3
        ...
        ld_snapshot_date                 VARCHAR2 (100); -- Added as per CCR0008682
        --3.2 changes start
        lv_segment1                      gl_code_combinations_kfv.segment1%TYPE;
        lv_segment2                      gl_code_combinations_kfv.segment2%TYPE;
        lv_segment3                      gl_code_combinations_kfv.segment3%TYPE;
        lv_segment4                      gl_code_combinations_kfv.segment4%TYPE;
        lv_segment5                      gl_code_combinations_kfv.segment5%TYPE;
        lv_segment6                      gl_code_combinations_kfv.segment6%TYPE;
        lv_segment7                      gl_code_combinations_kfv.segment7%TYPE;
        lv_segment8                      gl_code_combinations_kfv.segment8%TYPE;
        lv_item_brand                    gl_code_combinations_kfv.segment2%TYPE;
      ...
      ORDER BY brand, style, color, sze;*/
        ...
        IS
              ...
              SELECT SUM (DECODE (xcd.tpe, 'ONHAND', xcd.quantity, 0)) AS onhand_qty, ROUND (AVG (xcmic.macau_cost), 2) AS macau_cost, -- Start changes by BT Technology Team on 22-Jun-2015 for defect#2322
                                                                                                                                       ...
                                                                                                                                       SUM (DECODE (xcd.tpe,  'ONHAND', 0,  'RD', 0,  xcd.quantity)) AS rpt_intrans_qty, --Added for change 3.3
                     SUM (DECODE (xcd.tpe, 'RD', xcd.quantity, 0)) AS rec_intrans_qty, --Added for change 3.3                   ,
                                                                                       gsob.currency_code -- Added by BT Technology Team on 23-Jun-2015 for defect#2322
    ...
    BEGIN
        ...
        THEN
            ...
            BEGIN
                ...
                -- 3.6 calling the load temp table
                IF p_inv_org_id = 126
                THEN
                    BEGIN
                ...
                INSERT INTO xxdo.xxdoinv_cir_data (tpe,
                    ...
                    (                                            -- On-Hand --
                     ...
                     -- Added for change 3.4 -- commented for -- 3.5
                     -- 3.6 changes end
                       ...
                       SELECT 'B2B'
                         ...
                         FROM (  SELECT ms.to_organization_id AS organization_id,
                                  ...
                                  WHERE     ms.to_organization_id =
                                        ...
                                        -- 3.6 changes start
                                        AND ms.to_organization_id NOT IN
                                                (SELECT ood.organization_id
                                                   FROM fnd_lookup_values fl, org_organization_definitions ood
                                                  WHERE     fl.lookup_type =
                                                            'XDO_PO_STAND_RECEIPT_ORGS'
                            ...
                            AND rsl.to_organization_id IN
                                    (SELECT ood.organization_id
                                      ...
                                      WHERE     fl.lookup_type =
                                                'XDO_PO_STAND_RECEIPT_ORGS'
                                            AND fl.meaning =
                                                ood.organization_code)-- 3.6 changes end
                ...
                BEGIN
                    ...
                    THEN
                        ...
                        v_string   :=
                            ...
                            || g_delim_char
                            || 'Sub class'
                            || g_delim_char -- CR#92 added Item Type BT Technology Team
                            || 'Item Type'
                            --|| g_delim_char
                            --|| 'Master Style'
                            --|| g_delim_char
                        ...
                        THEN
                            ...
                            THEN
                                v_string   :=
                                    ...
                                    || ' Total Cost'
                                    || g_delim_char
                                    || c_org.organization_code -- Added by BT Technology Team on 12-JUn-2015 for defect#2322
                                    || ' On Hand Value'
                                    || g_delim_char
                                    --start changes by BT Technology Team on 22-Jun-2015 for defect#2322
                                    || c_org.organization_code
                                    ...
                                    --|| g_delim_char
                                    --|| c_org.organization_code
                                    --|| ' Intransit Qty (PO Receiving)'--Added for change 3.3
                                    --|| g_delim_char
                                    --|| c_org.organization_code
                                    --|| ' Intransit Value (PO Receiving)'--Added for change 3.3
                                    -- 3.5
                                    || g_delim_char
                                    || c_org.organization_code
                                    || ' Total Inventory QTY'
                        ...
                        */
                        ...
                        THEN
                            ...
                            v_string   :=
                                ...
                                || g_delim_char
                                || scrub_value (c_product.item_type) -- CR#92 added Item Type BT Technology Team
                                -- || g_delim_char
                        ...
                        LOOP
                            l_det_cnt           := 0;
                            l_material_cost     := 0; -- Start Added by BT Technology Team On 15/01/2014
                            --  l_duty_rate  :=0;
                            l_freight_du        := 0;
                            l_freight           := 0;
                            l_oh_duty           := 0;
                            ...
                            l_default_duty      := 0;
                            l_ext_mat_cost      := 0;
                            l_ext_mac_cost      := 0; -- End Added by BT Technology Team On 15/01/2014
                            l_total_cost        := 0;
                            l_total_value       := 0;
                            l_iprofit           := 0;
                            l_tq_markup         := 0;
                            ...
                            FOR c_detail
                                IN c_details_rpt (c_org.organization_id,
                                                  c_product.style,
                                                  c_product.color,
                                                  c_product.sze,
                                                  l_use_date)
                            LOOP
                                ...
                                */
                                ...
                                l_total_value           :=
                                    (l_total_cost * NVL (c_detail.onhand_qty, 0)); --Added BY BT Technology on 12-Jun-2015 for defect#2322
                                -- Start Changes by BT Technology Team on 22-Jun-2015 for defect#2322
                                l_intrans_val           :=
                                ...
                                l_tot_inv_qty           :=
                                      c_detail.onhand_qty
                                    + c_detail.rpt_intrans_qty; --Commented for change 3.3 -- uncommented for 3.5
                                --l_tot_inv_qty :=  c_detail.onhand_qty + c_detail.rpt_intrans_qty+ c_detail.rec_intrans_qty;-- Added for change 3.3 -- commented for 3.5
                                l_tot_inv_val           :=
                                    l_total_value + l_intrans_val; --Commented for change 3.3 -- 3.5
                                --l_tot_inv_val := l_total_value + l_intrans_val+l_intrans_rec_val;-- Added for change 3.3 --3.5
                                l_ext_mat_cost          :=
                                ...
                                THEN
                                    ...
                                    THEN
                                        v_string   :=
                                            ...
                                            || NVL (l_total_cost, 0)
                                            || g_delim_char
                                            || NVL (l_total_value, 0) -- Added by BT Technology Team on 12-Jun-2015 for defect#2322
                                            || g_delim_char
                                            --Start Changes by BT Technology Team on 22-Jun-2015 for defect#2322
                                            || NVL (c_detail.rpt_intrans_qty,
                                                    0)
                                            || g_delim_char
                                            || NVL (l_intrans_val, 0)
                                            || g_delim_char
                                            ...
                                            || g_delim_char
                                            || NVL (l_intrans_nonoh_duty_val,
                                                    0)
                                            --3.5
                                            --|| g_delim_char
                                            --End Changes by BT Technology Team on 22-Jun-2015 for defect#2322
                                            --||NVL (c_detail.rec_intrans_qty, 0) --Added for change 3.3
                                            --|| g_delim_char  --Added for change 3.3
                                            --|| l_intrans_rec_val --Added for change 3.3
                                            --3.5
                                            || g_delim_char --Added for change 3.3
                                            || NVL (l_tot_inv_qty, 0)
                                            || g_delim_char
                                    ...
                                    fnd_file.put (
                                        ...
                                        --Start Changes V2.1
                                        || g_delim_char
                                        || ROUND (c_detail.avg_mrgn_cst_usd,
                                                  2)
                                        || g_delim_char
                                        || ROUND (
                                               c_detail.avg_mrgn_cst_local,
                                        ...
                                        || g_delim_char
                                        || ROUND (ln_intst_trx_mrgn_cst_usd,
                                                  2)
                                        || g_delim_char
                                        || ROUND (
                                               ln_intst_trx_mrgn_cst_local,
                                ...
                                --End Changes by BT Technology Team on 23-Jun-2015 for defect#2322
                                -- 3.2 changes start
                                -- Query to fetch material account segments for given organization
                                BEGIN
                                    SELECT gcc.segment1, gcc.segment2, gcc.segment3,
                                      ...
                                      INTO lv_segment1, lv_segment2, lv_segment3, lv_segment4,
                                                      ...
                                                      lv_segment8
                                      FROM mtl_parameters mp, gl_code_combinations_kfv gcc
                                ...
                                THEN
                                    BEGIN
                                        SELECT TO_CHAR (LAST_DAY (SYSDATE), 'DD-MON-YYYY')
                                ...
                                ELSE
                                    BEGIN
                                        SELECT TO_CHAR (LAST_DAY (TO_DATE (p_as_of_date, 'YYYY/MM/DD HH24:MI:SS')), 'DD-MON-YYYY')
                                          INTO lv_period_end_date
                                          FROM DUAL;
                                    EXCEPTION
                                        WHEN OTHERS
                                ...
                                -- AAR
                                BEGIN
                                    INSERT INTO xxdo.xxd_inv_givr_acct_detls_t (
                                                    style,
                                                    color_code,
                                                    item_size,
                                                    description,
                                                    ...
                                                    intransit_qty,
                                                    intransit_val,
                                                    intransit_material_val,
                                                    intransit_duty_val,
                                                    intransit_freight_val,
                                                    intransit_freight_du_val,
                                                    intransit_oh_duty_val,
                                                    intransit_oh_nonduty_val,
                                                    total_inventory_qty,
                                                    total_inventory_val,
                                                    extended_material_cost,
                                                    macau_cost,
                                                    extended_macau_cost,
                                                    avg_margin_value_usd,
                                                    avg_margin_value_local,
                                                    inventory_org,
                                                    ...
                                                    last_update_date,
                                                    request_id,
                                                    intransit_qty_po_rev, --3.3
                                                    intransit_val_po_rev --3.3
                                                                        )
                                             VALUES (
                                                        c_product.style,
                                                        c_product.color,
                                                        c_product.sze,
                                                        c_product.item_description,
                                                        c_product.brand,
                                                        c_product.department,
                                                        c_product.master_class,
                                                        c_product.sub_class,
                                                        c_product.item_type,
                                                        c_product.intro_season,
                                                        c_product.current_season,
                                                        NVL (l_default_duty,
                                                             0),
                                                        NVL (
                                                            c_detail.onhand_qty,
                                                        ...
                                                        NULL, --c_detail.rec_intrans_qty, --3.3--3.5
                                                        NULL --l_intrans_rec_val --3.3,--3.5
                                                            );
        ...
        THEN
            ...
            BEGIN
                                              ...
                                              HAVING SUM (
                                                        DECODE (
                                                           ...
                                                           'CORRECT', DECODE (
                                                                         ...
                                                                         0),
                                                           0)) <> 0*/
                                           -- commented for change 3.4
                                           ) alpha
                     GROUP BY organization_id, inventory_item_id, rcv_transaction_id
                       HAVING SUM (quantity) != 0
                     /*End of changes for 3.3*/
                     -- 3.6 changes start
                     UNION ALL
                     SELECT 'B2B'
                                AS tpe,
                ...
                -- 3.2 changes strat to write the file into directory
                -- 3.2 changes start
                BEGIN
                    SELECT ffvl.attribute1, ffvl.attribute3
                      INTO lv_vs_file_path, lv_vs_file_name
                    ...
                    LOOP                         --Printing Item Level Records
                        ...
                        LOOP
                            ...
                            LOOP
                                ...
                                l_tot_inv_qty           :=
                                      c_detail.onhand_qty
                                    + c_detail.rpt_intrans_qty; --Commneted for change 3.3 -- 3.5

                                /* l_tot_inv_qty :=
                           c_detail.onhand_qty + c_detail.rpt_intrans_qty+ c_detail.rec_intrans_qty; */
                                                  -- Added for change 3.3--3.5

                                l_tot_inv_val           :=
                                    l_total_value + l_intrans_val; --Commneted for change 3.3--3.5
                                --l_tot_inv_val := l_total_value + l_intrans_val+l_intrans_rec_val; -- Added for change 3.3 -- 3.5
                                l_ext_mat_cost          :=
                                      (c_detail.onhand_qty * l_material_cost)
                                    + l_intrans_mat_val;
        ...
        do_debug_tools.msg ('-' || l_proc_name);
    END;
END XXDOINV_CONSOL_INV_EXTRACT_PKG;
/
