--
-- XXDO_INV_INTRANSIT_EXT_PKG  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--
/* Formatted on 4/26/2023 4:16:20 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE APPS."XXDO_INV_INTRANSIT_EXT_PKG"
AS
    /******************************************************************************************
    ...
    *   06-May-2021    Showkath Ali           V1.6     AAR Project
    *   03-Sep-2021    SHowkath ALi           V1.7     CCR0009519
    *   30-Jan-2022    Showkath Ali           V1.8     Changes as per CCR0009826 -- Marubeni changes
    ************************************************************************************************/
    ...
    PROCEDURE run_intransit_report (psqlstat OUT VARCHAR2, perrproc OUT VARCHAR2, p_inv_org_id IN NUMBER, p_region IN VARCHAR2, p_as_of_date IN VARCHAR2, p_cost_type_id IN NUMBER, p_brand IN VARCHAR2, p_show_color IN VARCHAR2, p_shipment_num IN VARCHAR2 --aded as per defect#672
                                    ...
                                    ,                                   -- AAR
                                      p_material_cost_for_pos IN VARCHAR2 -- V1.8
                                                                         );
