--
-- XXDO_DEC_CUST_STMT_CA_PKG  (Package Body) 
--
/* Formatted on 4/26/2023 4:34:05 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE BODY APPS."XXDO_DEC_CUST_STMT_CA_PKG"
IS
    PROCEDURE MAIN (p_error_code IN OUT NUMBER, p_error_message IN OUT NUMBER, P_REP_TYPE VARCHAR2, --Report Type
        ...
        LOOP
            ...
            l_layout         :=
                fnd_request.add_layout (
                    ...
                    template_code        => 'XXDOAR013_CA_REPORT',
