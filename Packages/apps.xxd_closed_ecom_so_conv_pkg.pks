--
-- XXD_CLOSED_ECOM_SO_CONV_PKG  (Package) 
--
--  Dependencies: 
--   FND_GLOBAL (Package)
--   STANDARD (Package)
--
/* Formatted on 4/26/2023 4:19:35 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE APPS.xxd_closed_ecom_so_conv_pkg
/**********************************************************************************************************

    File Name    : XXD_ONT_CLOSED_ECOM_SO_CONV_PKG
