--
-- XXD_ONT_DIST_SO_CONV_PKG  (Package) 
--
--  Dependencies: 
--   FND_GLOBAL (Package)
--   STANDARD (Package)
--
/* Formatted on 4/26/2023 4:23:08 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE APPS.XXD_ONT_DIST_SO_CONV_PKG
/**********************************************************************************************************

    File Name    : XXD_ONT_SALES_ORDER_CONV_CP_PKG
