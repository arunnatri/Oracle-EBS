--
-- XXDOINV_PLM_ITEM_GEN_PKG_BKP  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--
/* Formatted on 4/26/2023 4:14:23 PM (QP5 v5.362) */

CREATE OR REPLACE PACKAGE APPS."XXDOINV_PLM_ITEM_GEN_PKG_BKP" AUTHID CURRENT_USER
IS
   /**********************************************************************************************************
