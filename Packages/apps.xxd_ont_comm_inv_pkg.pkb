--
-- XXD_ONT_COMM_INV_PKG  (Package Body) 
--
/* Formatted on 4/26/2023 4:28:53 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE BODY APPS."XXD_ONT_COMM_INV_PKG"
AS
    /****************************************************************************************
    * Package      : XXD_ONT_COMM_INV_PKG
    * Design       : This package is used for Commercial Invoice Printing for shipments until
    *                31-Dec-2020
    * Notes        :
    * Modification :
    -- ===============================================================================
    ...
    ******************************************************************************************/
    ...
    AS
        CURSOR get_org_address_c IS
            SELECT mp.organization_code, houv.address_line_1, houv.address_line_2,
                   houv.town_or_city, houv.postal_code, ftv.territory_short_name,
