--
-- XXD_AR_IC_INV_OUTBOUND_PKG  (Package) 
--
--  Dependencies: 
...
--   STANDARD (Package)
--
/* Formatted on 4/26/2023 4:19:01 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE APPS."XXD_AR_IC_INV_OUTBOUND_PKG"
/***************************************************************************************
* Program Name : XXD_AR_CB_INV_OUTBOUND_PKG                                            *
* Language     : PL/SQL                                                                *
* Description  : Package                                                               *
*                                                                                      *
* History      :                                                                       *
