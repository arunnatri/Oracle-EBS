--
-- XXD_PROJ_INV_CATEGORY_CNV_PKG  (Package) 
--
--  Dependencies: 
--   FND_GLOBAL (Package)
--   FND_PROFILE (Package)
--   STANDARD (Package)
--   XXD_PLM_ATTR_STG_PROJ_T (Table)
--
/* Formatted on 4/26/2023 4:25:17 PM (QP5 v5.362) */
CREATE OR REPLACE PACKAGE APPS."XXD_PROJ_INV_CATEGORY_CNV_PKG"
AS
    -- +==============================================================================+
    -- +                                                            +
    -- +==============================================================================+
    ...
    gc_source_table_name   CONSTANT VARCHAR2 (50)
                                        := 'XXD_CONV.XXD_PLM_ATTR_STG_PROJ_T' ;
    ...
    TYPE item_categories_tbl
        IS TABLE OF XXD_CONV.XXD_PLM_ATTR_STG_PROJ_T%ROWTYPE
        INDEX BY BINARY_INTEGER;
